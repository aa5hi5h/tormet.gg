    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-red-900 to-black text-white">
      ...
      <header className="border-b border-white/10 backdrop-blur-sm bg-black/20">
        <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-2xl font-bold">Dota 2</h1>
              <p className="text-xs text-red-300">Strategy • Teamwork • Victory</p>
            </div>
          </div>
      ...
      <main className="max-w-7xl mx-auto px-6 py-8">
        ...
        <div className="bg-gradient-to-r from-red-500/20 to-orange-500/20 border border-red-400/30 rounded-xl p-6 mb-8">
          ...
          <ol className="space-y-2 text-sm text-red-100 list-decimal list-inside">
          ...
          <div className="mt-4 bg-red-900/30 border border-red-500/30 rounded-lg p-3">
            <p className="text-sm font-semibold text-red-200">💡 Finding Your Account ID:</p>
            <p className="text-xs text-red-300 mt-1">
              1. Open Dota 2 → Settings → Options<br/>
              2. Enable "Expose Public Match Data"<br/>
              3. Your Account ID is in your profile URL: <code className="bg-black/30 px-1 rounded">steamcommunity.com/profiles/[YOUR_ID]</code><br/>
              4. Or use: <a href="https://www.dotabuff.com/" target="_blank" className="text-blue-400 hover:underline">Dotabuff.com</a> to find it
            </p>
          </div>
        </div>
        ...
        <div className="bg-white/5 backdrop-blur-lg border border-white/10 rounded-xl p-6 mb-8">
          <h2 className="text-2xl font-bold mb-6">⚔️ Create Match</h2>
          ...
          <div className="grid md:grid-cols-2 gap-4">
            <div>
              ...
              <input
                ...
                className="w-full bg-white/10 border border-white/20 rounded-lg px-4 py-3 focus:outline-none focus:border-red-500"
              />
            </div>

            <div>
              <label className="block text-sm font-medium mb-2">
                Dota 2 Account ID <span className="text-xs text-red-300">(numeric)</span>
              </label>
              <input
                type="text"
                value={accountId}
              ...
              />
              <p className="text-xs text-red-300 mt-1">
                💡 Find it in your Steam profile URL or Dotabuff
              </p>
            </div>
          ...
          <button
            ...
            disabled={loading || !username || !accountId}
            className="mt-6 w-full bg-gradient-to-r from-red-500 to-red-700 hover:from-red-600 hover:to-red-800 disabled:from-gray-500 disabled:to-gray-600 px-6 py-3 rounded-lg font-bold disabled:cursor-not-allowed"
          >
                ...
                return (
                  <div
                    ...
                    className={`bg-white/5 border rounded-xl p-5 ${
                      isMyMatch ? 'border-red-400/50 bg-red-500/10' : 'border-white/10'
                    }`}
                  >
                    <div className="flex justify-between items-center">
                      <div className="flex-1">
                        <div className="flex items-center gap-3 mb-2">
                          ...
                          <div>
                            ...
                            <p className="text-sm text-gray-400">
                              {match.summonerName1 || 'Dota 2 Player'} • ID: {match.summonerPuuid1} • {getTimeSince(match.createdAt)}
                            </p>
                          </div>
                        </div>
                        <div className="flex gap-4 text-sm">
                          ...
                          {isMyMatch && (
                            <span className="bg-red-500/20 text-red-300 px-3 py-1 rounded-full animate-pulse">
                    ...
                    {isParticipant && (
                      <div className="bg-red-900/30 border border-red-500/30 rounded-lg p-4 mt-4">
                        ...
                        <ol className="space-y-2 text-sm list-decimal list-inside">
                          ...
                          <li>Add opponent as friend (Steam ID: {match.creator.username === username ? match.summonerPuuid2 : match.summonerPuuid1})</li>
                        ...
                        <div className="mt-3 bg-orange-900/40 border border-orange-500/30 rounded p-3">
                          <p className="text-xs text-orange-200">💡 <strong>Tip:</strong> Easiest way is to create a lobby game (1v1 mid or full 5v5 with bots). Make sure "Expose Public Match Data" is enabled in Dota 2 settings!</p>
                        </div>
                      </div>
                    )}
                  </div>
                    ...
                    <div className="bg-gradient-to-r from-green-900/30 to-emerald-900/30 border border-green-500/30 rounded-lg p-4">
                      ...
                      <div className="flex justify-between items-center">
                        <div className={`flex-1 text-center p-3 rounded ${creatorWon ? 'bg-green-500/20' : 'bg-gray-800/30'}`}>
                          ...
                          <p className="text-xs text-gray-400 mt-1">ID: {match.summonerPuuid1}</p>
                        </div>
                        ...
                        <div className={`flex-1 text-center p-3 rounded ${joinerWon ? 'bg-green-500/20' : 'bg-gray-800/30'}`}>
                          ...
                          <p className="text-xs text-gray-400 mt-1">ID: {match.summonerPuuid2}</p>
                        </div>
                      </div>
                      {!isDraw && (
