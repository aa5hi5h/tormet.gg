...
const  ClashRoyalePage = () => {
  ...
  const getRandomImage = (matchId: string) => {
    ...
    return ClashRoyaleImages[hash% ClashRoyaleImages.length]
  }

  const getStatusBadge = (match: ClashRoyaleMatchProps) => {
      ...
      <div className="relative overflow-hidden">
        <div className="absolute inset-0">
          <img
            ...
            alt="Royale Background"
            className="w-full h-full object-cover opacity-20"
          />
          <div className="absolute inset-0 bg-gradient-to-br from-black/20 via-purple-900/20 to-black/20" />
        </div>

        <div className="absolute inset-0 bg-gradient-to-br from-purple-600/10 via-pink-600/10 to-blue-500/10">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-8 z-10">
              <div className="flex group">
                <div className="absolute inset-0 bg-gradient-to-br from-purple-500/30 to-pink-500/30 rounded-2xl blur-xl group-hover:blur-2xl transition-all" />
                ...
                <div>
                  <div className="flex items-center gap-2 ml-4 mb-4">
                    ...
                    <span className="text-purple-400 text-sm font-semibold">Arena Battles</span>
                  </div>
                  ...
                  <p className="text-purple-200 text-lg ml-4 mb-6">
                    Wager SOL and prove your card mastery
                  </p>
                </div>
              </div>
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="bg-zinc-900/80 backdrop-blur-sm border border-purple-500/20 rounded-xl p-4">
                  ...
                  <div className="text-xs text-purple-300 font-semibold">ACTIVE BATTLES</div>
                </div>
            ...
            <div className="relative h-[500px] lg:h-[600px] z-10">
              ...
              <div className="absolute top-20 left-0 bg-black/80 backdrop-blur-md border border-purple-500/30 px-6 py-4 rounded-xl">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <div className="text-3xl font-black text-white">#{username ? '156' : '---'}</div>
      ...
      <div className="container mx-auto px-6 py-12">
        <div className="flex flex-col mb-8">
          <div className="flex items-center justify-between">
            <h2 className="text-3xl font-black tracking-tight text-white">OPEN BATTLES</h2>
          ...
          <p className="pl-1 text-slate-300">Join the arena and battle for glory</p>
        </div>
                  ...
                  <div className="p-4 space-y-3">
                    ...
                    {match.status === 'WAITING' && !isMyMatch && (
                      <button 
                        ...
                        className="w-full bg-gradient-to-r from-purple-600 to-pink-600 hover:from-purple-500 hover:to-pink-500 text-white rounded-xl font-bold transition-all shadow-lg shadow-purple-500/20 hover:shadow-purple-500/40 flex items-center overflow-hidden group/btn"
                      >
                        <span className="flex-1 text-lg font-mono py-3">Join Battle</span>
                      </button>
                    )}
        ...
        {matches.length === 0 && (
          <div className="border-2 border-dashed border-zinc-800 rounded-xl p-16 text-center">
            ...
            <p className="text-zinc-500 text-xl font-bold mb-2">NO ACTIVE BATTLES</p>
            ...
            <div className="space-y-4 text-sm text-gray-300">
              ...
              <div className="bg-pink-900/20 border border-pink-500/30 rounded-lg p-4">
                ...
                <ol className="space-y-1 list-decimal list-inside">
                  ...
                  <li>Tap your profile (top left)</li>
                  <li>Your Player Tag is shown below your name (e.g., #ABC123XYZ)</li>
                  <li>Tap to copy it!</li>
                </ol>
              </div>
              ...
              <div className="bg-blue-900/20 border border-blue-500/30 rounded-lg p-4">
                ...
                <ol className="space-y-1 list-decimal list-inside">
                  <li>Add opponent as friend using their Player Tag</li>
                  <li>Go to Social → Friends → Challenge to Friendly Battle</li>
                  <li>Play 1v1 (standard rules)</li>
                  <li>Winner detected automatically!</li>
                </ol>
              </div>
      ...
      {showCreateModal && (
        <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center z-50 p-4">
          <div className="bg-zinc-900/95 backdrop-blur-sm border border-purple-500/30 rounded-xl p-6 max-w-md w-full">
            <div className="flex items-center justify-between mb-6">
              <h3 className="text-2xl font-black text-white">Create Battle</h3>
            ...
            <div className="space-y-4">
              ...
              <div>
                <label className="text-xs text-purple-300 font-semibold mb-2 block">
                  PLAYER TAG <span className="text-pink-400">(e.g., #ABC123XYZ)</span>
                </label>
                <input
                ...
                />
                <p className="text-xs text-gray-400 mt-1">Find in-game: Profile → Player Tag</p>
              </div>
              ...
              <button 
                ...
                disabled={!username || !playerTag || loading || parseFloat(wager || '0') <= 0}
                className="bg-gradient-to-r from-purple-600 via-pink-600 to-blue-500 hover:from-purple-500 hover:via-pink-500 hover:to-blue-400 text-white px-8 py-4 rounded-lg font-black text-lg w-full disabled:from-zinc-700 disabled:to-zinc-700 disabled:cursor-not-allowed transition-all shadow-lg shadow-purple-500/20 hover:shadow-purple-500/40"
              >
